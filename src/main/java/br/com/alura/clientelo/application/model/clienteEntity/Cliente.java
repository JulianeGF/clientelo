package br.com.alura.clientelo.application.model.clienteEntity;
...
public class Cliente {
    ...
    public BigDecimal getMontanteGasto() {
        return this.pedidos.stream().map(Pedido::getTotalPedido).reduce(BigDecimal.ZERO, BigDecimal::add);
    }
}
