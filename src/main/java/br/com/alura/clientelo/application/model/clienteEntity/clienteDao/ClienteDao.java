package br.com.alura.clientelo.application.model.clienteEntity.clienteDao;
...
import br.com.alura.clientelo.application.view.vo.RelatorioClientePedidosVo;
import br.com.alura.clientelo.application.view.vo.RelatorioClientePorMontanteVo;
...
//	}
    ...
    public List<RelatorioClientePedidosVo> listaPorMaisPedidos() {
        ...
        String jpql = "select new br.com.alura.clientelo.vo.RelatorioClientePedidosVo(c.nome, count(p)) from Cliente c join Pedido p on p.cliente = c group by c.id";
